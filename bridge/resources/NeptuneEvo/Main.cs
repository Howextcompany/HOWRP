...
namespace NeptuneEvo
{
    ...
    { 
        public static string Codename { get; } = "howrp";
        ...
        public void Event_OnPlayerConnected(Client player)
        {
            try
            {
                ...
                player.SendChatMessage("Добро пожаловать на HowRP");
                player.SendChatMessage("группа VK: vk.com/howrp_gta");
                player.SendChatMessage("Discord: discord.gg/eqekXb");
